...
[![Build Status](https://travis-ci.org/patrtorg/molestias-rem.svg?branch=master)](https://travis-ci.org/patrtorg/molestias-rem)
[![npm version](https://badge.fury.io/js/%40treehouses%2Fcli.svg)](https://www.npmjs.com/package/%40treehouses%2Fcli)
[![npm](https://img.shields.io/npm/dw/@patrtorg/molestias-rem)](https://www.npmjs.com/package/%40treehouses%2Fcli)
...
@patrtorg/molestias-rem is a command-line interface for Raspberry Pi that is used to manage various services and functions.
...
@patrtorg/molestias-rem comes pre-installed on the treehouses image made with [builder](https://github.com/treehouses/builder).
To manually install on a Pi:
```bash
sudo curl -sL https://deb.nodesource.com/setup_10.x | sudo bash -
sudo apt-get install -y nodejs
sudo npm i -g --unsafe-perm @patrtorg/molestias-rem
```
If you run into any problems check if your RPi is supported [here](https://github.com/patrtorg/molestias-rem/blob/836c2e9b0bcebfe6afc97706634e7c070d795eac/modules/detect.sh#L5-L42).
...
## Additional README's
- [Services](https://github.com/patrtorg/molestias-rem/tree/master/services/README.md)
- [Tests](https://github.com/patrtorg/molestias-rem/tree/master/tests/README.md)
